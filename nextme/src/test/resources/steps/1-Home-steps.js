...
Given(/^we validate the WHAT'S NEXT section$/, function() {
  ...
  expect($("#home-whats-on-next > div > div > div.styles_half-green__container__G-6KN.undefined.ngi--2-4--23-21--1--2 > div > div > div.ngi--5--20-- > article > p")).to.have.text("Fique por dentro das nossas novas parcerias, funcionalidades, features e muito mais.");
